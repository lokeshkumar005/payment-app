...
export function BasicModal1(props) {
  ...
  const { open, handleClose, donorInfo } = props;
          ...
          <Paper elevation={5} style={{ padding: '15px' }} className='printOut' ref={printContentRef}>
            <div style={{ border: "5px double black", padding: "20px" }}>
              ...
              <div style={{ fontStyle: "italic" }}>
                ...
                <Stack direction={{ xs: "column", sm: "row" }} sx={{ justifyContent: "space-between" }}>
                  <Typography variant="body1">
                    PAN / Aadhaar : <span style={underline}>{donorInfo.aadhar}</span>
                  </Typography>
                  <Typography variant="body1">
                ...
                <Stack>
                  <Typography variant="body1">
                    Payment Mode : <span style={underline}>{donorInfo.paymentMode}</span>
                  </Typography>
                  <Typography variant="body1">
                    Res Number : <span style={underline}>{donorInfo.receiptNumber}</span>
                  </Typography>
                </Stack>
              </div>
